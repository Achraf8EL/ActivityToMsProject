 ...
 * @generated
 */
public class MmactivitySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MmactivityPackage.STATE_MACHINE: {
				StateMachine stateMachine = (StateMachine)theEObject;
				T result = caseStateMachine(stateMachine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MmactivityPackage.STATE_VERTEX: {
				StateVertex stateVertex = (StateVertex)theEObject;
				T result = caseStateVertex(stateVertex);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MmactivityPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MmactivityPackage.PSEUDOSTATE: {
				Pseudostate pseudostate = (Pseudostate)theEObject;
				T result = casePseudostate(pseudostate);
				if (result == null) result = caseStateVertex(pseudostate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MmactivityPackage.ACTION_STATE: {
				ActionState actionState = (ActionState)theEObject;
				T result = caseActionState(actionState);
				if (result == null) result = caseStateVertex(actionState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MmactivityPackage.FINAL_STATE: {
