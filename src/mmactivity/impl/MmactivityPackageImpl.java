...
import mmactivity.MmactivityFactory;
 ...
 * @generated
 */
public class MmactivityPackageImpl extends EPackageImpl implements MmactivityPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see mmactivity.MmactivityPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MmactivityPackageImpl() {
		super(eNS_URI, MmactivityFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link MmactivityPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static MmactivityPackage init() {
		if (isInited) return (MmactivityPackage)EPackage.Registry.INSTANCE.getEPackage(MmactivityPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredMmactivityPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		MmactivityPackageImpl theMmactivityPackage = registeredMmactivityPackage instanceof MmactivityPackageImpl ? (MmactivityPackageImpl)registeredMmactivityPackage : new MmactivityPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theMmactivityPackage.createPackageContents();

		// Initialize created meta-data
		theMmactivityPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theMmactivityPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(MmactivityPackage.eNS_URI, theMmactivityPackage);
		return theMmactivityPackage;
	}
	 ...
	 */
	@Override
	public EAttribute getStateVertex_Name() {
		return (EAttribute)stateVertexEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public MmactivityFactory getMmactivityFactory() {
		return (MmactivityFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(stateVertexEClass, STATE_VERTEX__NAME);
	...
	public void initializePackageContents() {
		...
		actionStateEClass.getESuperTypes().add(this.getStateVertex());
		...
		initEReference(getStateMachine_Subvertex(), this.getStateVertex(), null, "subvertex", null, 0, -1, StateMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStateVertex_Name(), ecorePackage.getEString(), "name", null, 0, 1, StateVertex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(transitionEClass, Transition.class, "Transition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTransition_Source(), this.getStateVertex(), null, "source", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_Target(), this.getStateVertex(), null, "target", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
