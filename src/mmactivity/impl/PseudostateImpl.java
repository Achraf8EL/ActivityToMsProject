 ...
 * </p>
 * <ul>
 *   <li>{@link mmactivity.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PseudostateImpl extends StateVertexImpl implements Pseudostate {
	...
	protected EClass eStaticClass() {
		return MmactivityPackage.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MmactivityPackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MmactivityPackage.PSEUDOSTATE__KIND:
				return getKind();
		}
